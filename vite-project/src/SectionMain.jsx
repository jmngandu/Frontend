...
export default function SectionMain() {
    return(
        <>
        <div className="
        mainsec1">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Expedita eius in, velit hic quisquam alias fugit debitis quibusdam, voluptate, voluptatum itaque dolorem? Cumque incidunt minima numquam, omnis eveniet eum aperiam!</div>
        <div className="
